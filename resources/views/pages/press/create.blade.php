                        ...
                        <form class="form-horizontal" method="POST" action="{{url('/press/store')}}">
                            ...
                            <div class="form-group">
                                <div class="col-md-8 col-md-offset-4">
                                    ...
                                    <p>Натискаючи кнопку “Відправити” Ви підтверджуєте, що ознайомилися з <a href="http://khanifest.com/?page_id=346">правилами фестивалю</a> та даєте згоду на обробку даних оргкомітетом фестивалю.</p>
                                </div>
                            </div>
                        </form>
