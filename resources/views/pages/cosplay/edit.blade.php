                        ...
                        <div class="panel panel-default">
                            <div class="panel-body">
                                <ul>
                                    ...
                                    <li><i class="fa fa-file-image-o" aria-hidden="true"></i> возвожные формати картинок/фото: jpeg,jpg,png</li>
                                    <li><i class="fa fa-file-audio-o" aria-hidden="true"></i> возвожные аудио формати: ogg, mp3, wav, wma, mid, flac, aac, alac, ac3, m4a, aif, iff, m3u, mpa, ra</li>
                                    <li><i class="fa fa-file-o" aria-hidden="true"></i> возвожные формати документов: doc, rtf, pdf, docx, sxw, txt, odt </li>
