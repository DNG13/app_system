...
@section('title', 'Ролі користувача')
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" method="POST" action="{{ route('user-role.update', $user->user_id)}}">
                            ...
                            <div class="form-group{{ $errors->has('title') ? ' has-error' : '' }}">
                                <label for="title" class="col-md-4 control-label">Користувач</label>
                                <div class="col-md-6">
                                    <p>{{$user->nickname}}</p>
                            ...
                            <div class="form-group{{ $errors->has('key') ? ' has-error' : '' }}">
                                <label for="key" class="col-md-4 control-label">Вибрати ролі</label>
