        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    <div class="panel-heading">Редагування профілю<br><p style="color: red"><strong>* Поля обов'язкові для заповнення</strong></div>
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" method="POST" enctype="multipart/form-data" action="{{ route('profile') }}">
                            ...
                            <div class="form-group{{ $errors->has('avatar') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">Виберіть файл для зміни аватара (PNG,JPG,JPEG)
                            ...
                            <div class="form-group{{ $errors->has('city') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="city" placeholder="Населений пункт" type="text" class="form-control" name="city" value="{{ $profile->city }}" required autofocus>
